...
{-| Core functions for working with D3.
...
# Selections
@docs enter, update, exit, attr, style, property, classed, html, text, str, num, fun

# Combining Selections
@docs sequence, chain, select, selectAll, append, static, remove

# Widgets
@docs bind, chain', embed
